...
function checkActivity() {
  ...
  // Verificar a inatividade para cada usuário individualmente
  lastActivityTime.forEach((activityTime, user) => {
    const inactiveDuration = (currentTime - activityTime) / (1000 * 60); // Duração em minutos

    if (!trackingDisabled && inactiveDuration >= 15) { // Verifica inatividade de 15 minutos
