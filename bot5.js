...
function checkActivity(user) {
    ...
    if (!trackingDisabled && inactiveDuration >= 10) {
        const inactivityMessage = 'Olá! Fique à vontade para me chamar novamente, digite 6 pra ver o menu.';
    ...
    if (!message.isGroupMsg) {
        ...
        switch (userOption) {
            ...
            case 5:
                ...
                break;
            case 6: // Adicione este caso para reenviar o menu de boas-vindas
                sendWelcomeMessage(user);
                break;
            default:
